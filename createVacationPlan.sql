DROP TABLE `vacationplanner_db`.`vacationplan` 

CREATE TABLE IF NOT EXISTS `vacationplanner_db`.`vacationplan` (  
   anIndex BIGINT PRIMARY KEY, 
   vacationNum BIGINT, 
   rowNum INT,
   dayDate DATE,
   travelTime DECIMAL, 
   startingLocation VARCHAR(80),
   endingLocation  VARCHAR(80),
   morning VARCHAR(80),
   afternoon VARCHAR(80),
   evening VARCHAR(80),
   lodging VARCHAR(80) );

CREATE TABLE IF NOT EXISTS `vacationplanner_db`.`vacationplan` ( anIndex BIGINT PRIMARY KEY, vacationNum BIGINT, rowNum INT, dayDate DATE, travelTime DECIMAL, startingLocation VARCHAR(80), endingLocation VARCHAR(80), morning VARCHAR(80), afternoon VARCHAR(80), evening VARCHAR(80), lodging VARCHAR(80) );
   
INSERT INTO `vacationplan`(`anIndex`, `vacationNum`, `rowNum`, `dayDate`, `travelTime`, `startingLocation`, `endingLocation`, `morning`, `afternoon`, `evening`, `lodging`) 
